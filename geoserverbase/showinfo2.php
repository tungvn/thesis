...
<head>
    ...
    function load() {
        map = new OpenLayers.Map('map', {
            maxExtent: new OpenLayers.Bounds(105.460469,21.765461000000002,106.210167,22.812731000000003)
        });
        ...
        */
        water = new OpenLayers.Layer.WMS("BacKan Layer",
            mainUrl, 
            {'layers': BacKanLoKhoan, transparent: true, format: 'image/png'},
            {isBaseLayer: true}
        );
        ...
        //map.zoomToMaxExtent();
        map.zoomTo(1);
    map.panTo(new OpenLayers.LonLat(21.8,105.5));
    }
